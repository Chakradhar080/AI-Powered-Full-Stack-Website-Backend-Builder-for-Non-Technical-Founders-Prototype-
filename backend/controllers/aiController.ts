...
export const generateCode = async (req: any, res: any) => {
  try {
...
export const optimizeLayout = async (req: any, res: any) => {
  try {
...
export const generateApi = async (req: any, res: any) => {
  try {
    ...
    const apiCode = ApiGenerationService.generateApiRoutes(requirements);
