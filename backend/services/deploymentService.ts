...
export class DeploymentService {
  ...
  static async deployToVercel(websiteData: any, vercelConfig: any) {
    try {
  ...
  static async deployToNetlify(websiteData: any, netlifyConfig: any) {
    try {
  ...
  static async deployToRender(websiteData: any, renderConfig: any) {
    try {
